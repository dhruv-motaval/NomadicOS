...
- [ ] Local web dashboard (build contract ready: docs/architecture/UI_PLAN.md): task dashboard, ASK-approval queue, memory manager,
...
```text
v0.1.0 (now)      internal, architecture complete
