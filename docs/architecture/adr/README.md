...
| [0030](ADR-0030-multi-agent-orchestration.md) | Multi-agent orchestration: planner + parallel workers + synthesizer, per-agent attribution | Owner decision |
| [0031](ADR-0031-postgres-native-install.md) | PostgreSQL 17 native Windows install with pgAdmin; Docker optional | Owner preference |
